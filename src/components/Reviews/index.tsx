        ...
        <div className="flex items-end justify-between gap-6 flex-wrap">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="w-12 h-12 rounded-full bg-accent text-bg grid place-items-center motion-safe:transition hover:bg-accentDark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
            >
